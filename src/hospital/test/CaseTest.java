...
import hospital.race.*;
import hospital.illness.Illness;
import hospital.illness.Illnesses;
import hospital.services.type.Crypt;
import hospital.services.type.QuarantineCenter;
...
public class CaseTest {
    ...
    public void setUp() {
        ...
        werewolf = new Werewolf("Werewolf", false, 32, 65.5F, 1.75F, illnesses.clone());
        ...
        service = new Service("Service", 100.0F, 10, 3, new Creature[]{orc, werewolf, beastMan}, 2);
    ...
    public void testLycanthropeConstructor() {
        assertEquals("Lycanthrope", werewolf.getName());
        assertFalse(werewolf.isMale());
        assertEquals(32, werewolf.getAge());
        assertEquals(65.5F, werewolf.getWeight());
        assertEquals(1.75F, werewolf.getHeight());
        assertArrayEquals(illnesses, werewolf.getIllnesses());
    }
    ...
    public void testLycanthropeSetAge() {
        werewolf.setAge(45);
        assertEquals(45, werewolf.getAge());
    }

    @Test
    public void testLycanthropeSetWeight() {
        werewolf.setWeight(65.5F);
        assertEquals(65.5F, werewolf.getWeight());
    }

    @Test
    public void testLycanthropeSetHeight() {
        werewolf.setHeight(1.75F);
        assertEquals(1.75F, werewolf.getHeight());
    }

    @Test
    public void testLycanthropeSetMale() {
        werewolf.setMale(true);
        assertTrue(werewolf.isMale());
    }

    @Test
    public void testLycanthropeSetName() {
        werewolf.setName("Lycanthrope2");
        assertEquals("Lycanthrope2", werewolf.getName());
    }

    @Test
    public void testLycanthropeSetIllnesses() {
        Illness[] illnesses2 = new Illness[]{new Illness(Illnesses.DRS), new Illness(Illnesses.MDC)};
        werewolf.setIllnesses(illnesses2);
        assertArrayEquals(illnesses2, werewolf.getIllnesses());
    }
    ...
    public void testServiceConstructor() {
        ...
        assertArrayEquals(new Creature[]{orc, werewolf, beastMan}, service.getCreatures());
    ...
    public void testHospitalSetServices() {
        Service[] services = new Service[]{service, crypt, quarantineCenter, new Service("Service2", 100.0F, 10, 5, new Creature[]{orc, werewolf, beastMan}, 2)};
    ...
    public void testHospitalGetCreatures() {
        ...
        assertArrayEquals(new Creature[]{orc, werewolf, beastMan, vampire, zombie, elf, dwarf}, creatures);
    }
