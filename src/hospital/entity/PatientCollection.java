...
public class PatientCollection implements Collection<Patient> {
    ...
    public Iterator<Patient> iterator() {
        return Arrays.stream(patients).iterator();
    }
     ...
     *
     * @param patient element whose presence in this collection is to be ensured
    ...
    public boolean add(Patient patient) {
        if (this.patients != null) {
            this.patients = Arrays.copyOf(this.patients, this.patients.length + 1);
            this.patients[this.patients.length - 1] = patient;
        } else {
    ...
    public String toString() {
        return Arrays.toString(this.patients);
    }
}
